...
[~,ipeaksMAX{ii}]=findpeaks(SpecMaxEnv{ii}./max(SpecMaxEnv{ii}),'minpeakheight',0.75);
NBRPEAKMAX(ii)=length(ipeaksMAX{ii});% Nbr peaks Max DFTs
[~,ipeaksMEAN{ii}]=findpeaks(SpecMeanEnv{ii}./max(SpecMeanEnv{ii}),'minpeakheight',0.75);
NBRPEAKMEAN(ii)=length(ipeaksMEAN{ii});% Nbr peaks Mean DFTs
[~,ipeaksMEDIAN{ii}]=findpeaks(SpecMedianEnv{ii}./max(SpecMedianEnv{ii}),'minpeakheight',0.75);
...
[~,ipeaksFREQCENTER{ii}]=findpeaks(FREQCENTER{ii}./max(FREQCENTER{ii}),'minpeakheight',0.75);
NBRPEAKFREQCENTER(ii)=length(ipeaksFREQCENTER{ii});% Nbr peaks X centroid Freq DFTs
[~,ipeaksFREQMAX{ii}]=findpeaks(FREQMAXCENTER{ii}./max(FREQMAXCENTER{ii}),'minpeakheight',0.75);
