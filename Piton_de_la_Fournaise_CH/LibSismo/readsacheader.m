function F=readsacheader(files)
% F=readsacheader('files')
%
% Read the header of a SAC-file or a set of SAC-files.
%
% Input :
...
%  It contains ALL the fields of the SAC's header except the trace wich is
%  set to [];
%
% see readsac.m for examples
%
